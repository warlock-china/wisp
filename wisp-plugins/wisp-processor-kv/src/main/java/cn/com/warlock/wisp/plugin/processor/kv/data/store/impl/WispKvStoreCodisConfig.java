...
@Data
public class WispKvStoreCodisConfig implements IConfig {

    protected static final Logger LOGGER = LoggerFactory.getLogger(WispKvStoreCodisConfig.class);
    ...
    public void init(IWispContext iWispContext) throws Exception {
        ...
        String codisFilePath = iWispContext.getProperty("wisp.plugin.processor.codis.filepath", CONFIG_FILE_NAME);
    ...
    private void loadConfigAndInit(String filePath) throws Exception {
        ...
        InputStream inputStream = WispKvStoreCodisConfig.class.getClassLoader().getResourceAsStream(filePath);
